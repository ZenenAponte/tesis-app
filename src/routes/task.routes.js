...
const {
  ...
  autenticarToken,
  login,
} = require("../controller/autenticar.controller");
const {
  getBloqueo,
  postBloqueo,
  putBloqueo,
  deleteBloqueo,
} = require("../controller/bloqueo.controller");
const {
  getCausa,
  postCausa,
  putCausa,
  deleteCausa,
} = require("../controller/causa.controller");
const {
  getCausaDescrip,
  postCausaDescrip,
  putCausaDescrip,
  deleteCausaDescrip,
} = require("../controller/causaDescrip.controller");
const {
  getContribuyente,
  postContribuyente,
  putContribuyente,
  deleteContribuyente,
  getContribuyenteID,
} = require("../controller/contribuyente.controller");
const {
  getDeduccion,
  postDeduccion,
  putDeduccion,
  deleteDeduccion,
} = require("../controller/deduccion.controller");
const {
  getDireccion,
  postDireccion,
  putDireccion,
  deleteDireccion,
} = require("../controller/direccion.controller");
const {
  getEstado,
  postEstado,
  putEstado,
  deleteEstado,
} = require("../controller/estado.controller");
const {
  getFormaPago,
  postFormaPago,
  putFormaPago,
...
const {
  ...
  putLugar,
  deleteLugar,
} = require("../controller/lugar.controller");
const {
  getNotificacion,
  postNotificacion,
  putNotificacion,
...
const {
  ...
  putSexo,
  deleteSexo,
} = require("../controller/sexo.controller");
const {
  getSolicitudEsp,
  postSolicitudEsp,
  putSolicitudEsp,
  deleteSolicitudEsp,
} = require("../controller/solicitudEsp.controller");
const {
  getTipoDesc,
  postTipoDesc,
  putTipoDesc,
  deleteTipoDesc,
} = require("../controller/tipoDesc.controller");
const {
  getTipoImp,
  postTipoImp,
  putTipoImp,
  deleteTipoImp,
} = require("../controller/tipoImp.controller");
const {
  getDeclaracion,
  postDeclaracion,
  putDeclaracion,
  deleteDeclaracion,
} = require("../controller/declaracion.controller");
const {
  getDevolucion,
  postDevolucion,
  putDevolucion,
  deleteDevolucion,
} = require("../controller/devolucion.controller");
const {
  getImpuesto,
  postImpuesto,
  putImpuesto,
  deleteImpuesto,
} = require("../controller/impuesto.controller");
const {
  getReclamo,
  postReclamo,
  putReclamo,
  deleteReclamo,
} = require("../controller/reclamo.controller");
...
router.get("/autenticar/verify", autenticarToken); //nuevo

router.post("/autenticar", postAutenticar);

router.post("/autenticar/login", login); //nuevo
...
router.get("/contribuyente/:dni", getContribuyenteID); //nuevo
